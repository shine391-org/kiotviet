...
class SalesInvoiceService
{
    ...
    protected SalesInvoiceValidator $validator;
    protected TaxTemplateRepository $taxTemplates;
    protected AccountingService $accounting;

    public function __construct(
        ?SalesInvoiceRepository $repo = null,
        ?SalesInvoiceValidator $validator = null,
        ?TaxTemplateRepository $taxTemplates = null,
        ?AccountingService $accounting = null
    ) {
        $this->repo = $repo ?? new SalesInvoiceRepository();
        $this->validator = $validator ?? new SalesInvoiceValidator();
     ...
     *
     * @agent-use: Service entry for POST /api/sales-invoices/preview
     */
    ...
    public function create(array $input): array
    {
        ...
        $schedules = $this->validator->validateSchedule($input['schedules'] ?? [], $totals['grand_total']);
        $invoice = $this->repo->create($invoiceRow, $totals['items'], $totals['taxes'], $schedules);
        ...
        $entries = $reverse
            ? [
                [
                    ...
                    'remarks' => 'Reverse sales invoice ' . $invoice['invoice_number'],
                ],
                [
