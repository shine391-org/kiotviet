...
class OrdersDemoSeeder extends Seeder
{
    ...
    private function buildOrderItems(array $orderIdMap, string $now): array
    {
        ...
        // Sử dụng sản phẩm có biến thể (510/511) + demo cũ (501-503)
        $line('DH-DEMO-001', 510, 8001, 5, 450000);
        $line('DH-DEMO-001', 511, 8012, 2, 1320000);

        $line('DH-DEMO-002', 501, 7001, 1, 7500000);
        $line('DH-DEMO-002', 503, null, 1, 1500000);

        $line('DH-DEMO-003', 510, 8003, 3, 450000);

        $line('DH-DEMO-004', 511, 8011, 2, 1250000);

        $line('DH-DEMO-005', 502, null, 1, 1950000);

        $line('DH-DEMO-006', 510, 8005, 2, 450000);

        $line('DH-DEMO-007', 511, 8014, 1, 1350000);

        $line('DH-DEMO-008', 510, 8002, 2, 450000, 1, 'VIP 20%');
        $line('DH-DEMO-008', 503, null, 1, 1200000, 1, 'VIP 20%');

        $line('DH-DEMO-009', 511, 8016, 1, 1360000);

        $line('DH-DEMO-010', 510, 8006, 2, 450000);

        $line('DH-DEMO-011', 511, 8015, 3, 1280000);

        $line('DH-DEMO-012', 501, 7002, 2, 5250000, 3, 'Flash Sale 30%');

        $line('DH-DEMO-013', 510, 8001, 2, 450000);

        $line('DH-DEMO-014', 511, 8013, 2, 1280000);

        $line('DH-DEMO-015', 501, 7001, 1, 7500000);
        $line('DH-DEMO-015', 510, 8004, 2, 450000);

        $line('DH-DEMO-016', 503, null, 2, 1200000);

        $line('DH-DEMO-017', 510, 8002, 1, 450000);
        $line('DH-DEMO-017', 511, 8011, 1, 1250000);

        $line('DH-DEMO-018', 511, 8012, 1, 1320000);
        $line('DH-DEMO-018', 510, 8003, 1, 450000);

        $line('DH-DEMO-019', 510, 8006, 2, 450000);

        $line('DH-DEMO-020', 511, 8015, 1, 1280000);
