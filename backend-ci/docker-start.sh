...
php -r '
  ...
  $sql = [
    ...
    "CREATE TABLE IF NOT EXISTS products (id INT AUTO_INCREMENT PRIMARY KEY, code VARCHAR(100), name VARCHAR(255), selling_price DECIMAL(10,2) DEFAULT 0, wholesale_price DECIMAL(10,2), created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL, deleted_at TIMESTAMP NULL)",
    "CREATE TABLE IF NOT EXISTS product_variants_v2 (id INT AUTO_INCREMENT PRIMARY KEY, product_id INT, sku VARCHAR(100), price DECIMAL(10,2), created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL, deleted_at TIMESTAMP NULL)",
