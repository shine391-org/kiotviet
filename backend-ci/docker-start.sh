...
$sql = [
  ...
  "CREATE TABLE customers (id INT AUTO_INCREMENT PRIMARY KEY, customer_group_id INT NULL, name VARCHAR(255), email VARCHAR(255) NULL, phone VARCHAR(50) NULL, created_at DATETIME NULL, updated_at DATETIME NULL, deleted_at DATETIME NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",
