...
$sql = [
  ...
  "CREATE TABLE IF NOT EXISTS product_images (id INT AUTO_INCREMENT PRIMARY KEY, product_id INT, variant_id INT, image_path VARCHAR(255), image_url VARCHAR(255), is_primary TINYINT DEFAULT 0, sort_order INT DEFAULT 0, file_name VARCHAR(255), created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL, deleted_at TIMESTAMP NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",
  "CREATE TABLE IF NOT EXISTS product_category_links (id INT AUTO_INCREMENT PRIMARY KEY, product_id INT, category_id INT, created_at TIMESTAMP NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",
  "CREATE TABLE IF NOT EXISTS product_attribute_values (id INT AUTO_INCREMENT PRIMARY KEY, product_id INT, variant_id INT, attribute_id INT, option_id INT, value_text TEXT, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL, deleted_at TIMESTAMP NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",
