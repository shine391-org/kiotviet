...
class ProductMediaSearchValidator
{
    ...
    {
        $v=$this->run(array_merge(['sku'=>'','limit'=>20,'entity_id'=>null],$input),[
        ...
        return ['sku'=>trim((string)($v['sku']??'')),'limit'=>(int)($v['limit']??20),'entity_id'=>isset($v['entity_id'])?(int)$v['entity_id']:null];
    }
